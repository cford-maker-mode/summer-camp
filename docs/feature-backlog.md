...
| Clear Privacy/Access Language | Friendly, clear UI copy explaining what data is accessed, where it’s stored, and how to revoke | Medium   | New      | Not in current app   |
| Camp Ownership Claim & Lock  | Allow camps to claim ownership with proper authorization to lock details from crowdsourcing | Medium   | New      | Needs secure auth   |
